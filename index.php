...
$main = new Main(isset($_GET['page'])?$_GET['page']:null, 5, isset($_GET['product'])?$_GET['product']:null);
...
$main->add_announcements_from_file('./resources/announcements.txt');


if(isset($_POST['filter_value'])&&$_POST['filter_value']!="")
{
    $main->filter_announcements($_POST['filter_key'],$_POST['filter_value']);
}
echo $main->Render();
